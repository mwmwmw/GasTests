...
const main = async () => {
    ...
    console.log("Testing all work write function, store results, base64 encode in output")

    const [owner, randomPerson, anotherRandom] = await hre.ethers.getSigners();
    const nftFactory = await hre.ethers.getContractFactory("contracts/RockPaperScissors64Out.sol:RPS");
