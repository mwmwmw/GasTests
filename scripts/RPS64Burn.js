...
const main = async () => {
    ...
    console.log("Testing all work write function, store results, useless base64 encoding")

    const [owner, randomPerson, anotherRandom] = await hre.ethers.getSigners();
    const nftFactory = await hre.ethers.getContractFactory("contracts/RockPaperScissors64Burn.sol:RPS");
