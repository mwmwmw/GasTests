...
const main = async () => {
    ...
    console.log("Testing all work write function, store base64 encoded results")

    const [owner, randomPerson, anotherRandom] = await hre.ethers.getSigners();
    const nftFactory = await hre.ethers.getContractFactory("contracts/RockPaperScissors64.sol:RPS");
